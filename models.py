...
#     lesson_date = DateTimeField(constraints=[SQL("DATE('now')")])
...
# class StudentReviews(Model):
#     student_id = ForeignKeyField(Students, backref='student_reviews', on_delete="CASCADE")
